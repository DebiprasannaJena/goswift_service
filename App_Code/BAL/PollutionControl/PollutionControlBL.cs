...
namespace SWP_Services.BL
{
    public class PollutionControlBL : IPollutionControlBL
    {
        ...
        /// <param name="objUser"></param>
        /// <returns></returns>
        [WebInvoke(Method = "POST", ResponseFormat = WebMessageFormat.Json, UriTemplate = "getUserProfilesBMW")]
        public List<PollutionControlUserProfile> GetUserProfilesBMW(PollutionAuthStatus objUser)
        {
            return obj.GetUserProfilesBMW(objUser);
        }
        #endregion
        ...
        /// <param name="objDATA"></param>
        /// <returns></returns>
        [WebInvoke(Method = "POST", ResponseFormat = WebMessageFormat.Json, UriTemplate = "SWPPushDataBMW")]
        public List<PollutionPushDataStatus> SWPPushDataBMW(PollutionPushData objDATA)
        {
            return obj.SWPPushDataBMW(objDATA);
        }
        #endregion
        ...
        /// <param name="objUser"></param>
        /// <returns></returns>
        [WebInvoke(Method = "POST", ResponseFormat = WebMessageFormat.Json, UriTemplate = "getUserProfilesMSW")]
        public List<PollutionControlUserProfile> GetUserProfilesMSW(PollutionAuthStatus objUser)
        {
            return obj.GetUserProfilesMSW(objUser);
        }
        #endregion
        ...
        /// <param name="objDATA"></param>
        /// <returns></returns>
        [WebInvoke(Method = "POST", ResponseFormat = WebMessageFormat.Json, UriTemplate = "SWPPushDataMSW")]
        public List<PollutionPushDataStatus> SWPPushDataMSW(PollutionPushData objDATA)
        {
            return obj.SWPPushDataMSW(objDATA);
        }
        #endregion
        ...
        /// <param name="objUser"></param>
        /// <returns></returns>
        [WebInvoke(Method = "POST", ResponseFormat = WebMessageFormat.Json, UriTemplate = "getUserProfilesCDW")]
        public List<PollutionControlUserProfile> GetUserProfilesCDW(PollutionAuthStatus objUser)
        {
            return obj.GetUserProfilesCDW(objUser);
        }
        #endregion
        ...
        /// <param name="objDATA"></param>
        /// <returns></returns>
        [WebInvoke(Method = "POST", ResponseFormat = WebMessageFormat.Json, UriTemplate = "SWPPushDataCDW")]
        public List<PollutionPushDataStatus> SWPPushDataCDW(PollutionPushData objDATA)
        {
            return obj.SWPPushDataCDW(objDATA);
        }
        #endregion
        ...
        /// <param name="objUser"></param>
        /// <returns></returns>
        [WebInvoke(Method = "POST", ResponseFormat = WebMessageFormat.Json, UriTemplate = "getUserProfilesRFD")]
        public List<PollutionControlUserProfile> GetUserProfilesRFD(PollutionAuthStatus objUser)
        {
            return obj.GetUserProfilesRFD(objUser);
        }
        #endregion
        ...
        /// <param name="objDATA"></param>
        /// <returns></returns>
        [WebInvoke(Method = "POST", ResponseFormat = WebMessageFormat.Json, UriTemplate = "SWPPushDataRFD")]
        public List<PollutionPushDataStatus> SWPPushDataRFD(PollutionPushData objDATA)
        {
            return obj.SWPPushDataRFD(objDATA);
        }
        #endregion
    }
}