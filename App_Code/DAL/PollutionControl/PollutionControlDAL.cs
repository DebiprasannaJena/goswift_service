...
namespace SWP_Services.DAL
{
    public class PollutionControlDAL : IPollutionControlDAL
    {
        ...
        #region  "Fetch User Profile Details For Bio-Medical Waste"
        /// <summary>
        /// Created By Anil Sahoo on 10-Oct-2022 for Fetch User Profile Details For Bio-Medical Waste
        /// </summary>
        /// <param name="objUser"></param>
        /// <returns></returns>
        public List<PollutionControlUserProfile> GetUserProfilesBMW(PollutionAuthStatus objUser)
        {
            SqlDataReader reader;
            List<PollutionControlUserProfile> list = new List<PollutionControlUserProfile>();
            object[] arr = new object[] {  "P_vch_Action","BMW",
                                           "P_vch_UserID",objUser.strUserID,
                                           "P_vch_ProposalID ",objUser.StrProposalID
                                        };
            try
        ...
        #endregion
        #region "Push User Data For Bio-Medical Waste"
        /// <summary>
        /// Created By Anil Sahoo on 10-Oct-2022 for Push User Data For Bio-Medical Waste
        /// </summary>
        /// <param name="objDATA"></param>
        /// <returns></returns>
        public List<PollutionPushDataStatus> SWPPushDataBMW(PollutionPushData objDATA)
        {
            ///// Write request log for each request.
            string strInput = "(Request)---Application No :- " + objDATA.strApplicationNumber;
            Util.LogRequestResponse("OSPCB", "SWPPushDataBMW", strInput);


            /*-----------------------------------------------------------*/
            ///// Write PUSH RECORD log for each request.
            JavaScriptSerializer jsonSerialiser1 = new JavaScriptSerializer();
            var json1 = jsonSerialiser1.Serialize(objDATA);
            string strPushdata = "(Pushdata)--- Data :- " + json1;
            Util.LogRequestResponse("OSPCB", "pushdataBMWservice", strPushdata);
            ...
            try
            {
                object[] objArray = new object[] { "P_vch_Action", "PBMW",
                                                   "P_vch_ProposalID",objDATA.strIndustryCode,
                                                   "P_VCH_INVESTOR_NAME",objDATA.strInvstorName,
                                                   "P_VCH_APPLICATION_UNQ_KEY",objDATA.strApplicationNumber,
                                                   "P_SERVICEID",objDATA.intServiceID,
                ...
                JavaScriptSerializer jsonSerialiser2 = new JavaScriptSerializer();
                var json2 = jsonSerialiser2.Serialize(objResponse);
                string strOutput = "(Response)---OutputString:- " + json2;
                Util.LogRequestResponse("OSPCB", "getResponseBMW", strOutput);
        ...
        #region  "Fetch User Profile Details For Municipal-Solid Waste"
        /// <summary>
        /// Created By Anil Sahoo on 11-Oct-2022 for Fetch User Profile Details For Municipal-Solid Waste
        /// </summary>
        /// <param name="objUser"></param>
        /// <returns></returns>
        public List<PollutionControlUserProfile> GetUserProfilesMSW(PollutionAuthStatus objUser)
        {
            SqlDataReader reader;
            List<PollutionControlUserProfile> list = new List<PollutionControlUserProfile>();
            object[] arr = new object[] {  "P_vch_Action","MSW",
                                           "P_vch_UserID",objUser.strUserID,
                                           "P_vch_ProposalID ",objUser.StrProposalID
                                        };
            try
        ...
        #endregion
        #region "Push User Data For Municipal-Solid Waste"
        /// <summary>
        /// Created By Anil Sahoo on 11-Oct-2022 for Push User Data For Municipal-Solid Waste
        /// </summary>
        /// <param name="objDATA"></param>
        /// <returns></returns>
        public List<PollutionPushDataStatus> SWPPushDataMSW(PollutionPushData objDATA)
        {
            ///// Write request log for each request.
            string strInput = "(Request)---Application No :- " + objDATA.strApplicationNumber;
            Util.LogRequestResponse("OSPCB", "SWPPushDataMSW", strInput);
            ...
            var json1 = jsonSerialiser1.Serialize(objDATA);
            string strPushdata = "(Pushdata)--- Data :- " + json1;
            Util.LogRequestResponse("OSPCB", "pushdataMSWservice", strPushdata);
            ...
            try
            {
                object[] objArray = new object[] { "P_vch_Action", "PMSW",
                                                   "P_vch_ProposalID",objDATA.strIndustryCode,
                                                   "P_VCH_INVESTOR_NAME",objDATA.strInvstorName,
                                                   "P_VCH_APPLICATION_UNQ_KEY",objDATA.strApplicationNumber,
                                                   "P_SERVICEID",objDATA.intServiceID,
                ...
                var json2 = jsonSerialiser2.Serialize(objResponse);
                string strOutput = "(Response)---OutputString:- " + json2;
                Util.LogRequestResponse("OSPCB", "getResponseMSW", strOutput);
        ...
        #region  "Fetch User Profile Details For Construction and Demolition Waste"
        /// <summary>
        /// Created By Anil Sahoo on 11-Oct-2022 for Fetch User Profile Details For Construction and Demolition Waste
        /// </summary>
        /// <param name="objUser"></param>
        /// <returns></returns>
        public List<PollutionControlUserProfile> GetUserProfilesCDW(PollutionAuthStatus objUser)
        {
            SqlDataReader reader;
            List<PollutionControlUserProfile> list = new List<PollutionControlUserProfile>();
            object[] arr = new object[] {  "P_vch_Action","CDW",
                                           "P_vch_UserID",objUser.strUserID,
                                           "P_vch_ProposalID ",objUser.StrProposalID
                                        };
            try
        ...
        #endregion
        #region "Push User Data For Construction and Demolition Waste"
        /// <summary>
        /// Created By Anil Sahoo on 11-Oct-2022 for Push User Data For Construction and Demolition Waste
        /// </summary>
        /// <param name="objDATA"></param>
        /// <returns></returns>
        public List<PollutionPushDataStatus> SWPPushDataCDW(PollutionPushData objDATA)
        {
            ///// Write request log for each request.
            string strInput = "(Request)---Application No :- " + objDATA.strApplicationNumber;
            Util.LogRequestResponse("OSPCB", "SWPPushDataCDW", strInput);
            ...
            var json1 = jsonSerialiser1.Serialize(objDATA);
            string strPushdata = "(Pushdata)--- Data :- " + json1;
            Util.LogRequestResponse("OSPCB", "pushdataCDWservice", strPushdata);
            ...
            try
            {
                object[] objArray = new object[] { "P_vch_Action", "PCDW",
                                                   "P_vch_ProposalID",objDATA.strIndustryCode,
                                                   "P_VCH_INVESTOR_NAME",objDATA.strInvstorName,
                                                   "P_VCH_APPLICATION_UNQ_KEY",objDATA.strApplicationNumber,
                                                   "P_SERVICEID",objDATA.intServiceID,
                ...
                var json2 = jsonSerialiser2.Serialize(objResponse);
                string strOutput = "(Response)---OutputString:- " + json2;
                Util.LogRequestResponse("OSPCB", "getResponseCDW", strOutput);
                lstResponse.Add(objResponse);
            }
            catch (SqlException ex)
            {
        ...
        #region  "Fetch User Profile Details For Registration for dealers"
        /// <summary>
        /// Created By Anil Sahoo on 11-Oct-2022 for Fetch User Profile Details For Registration for dealers
        /// </summary>
        /// <param name="objUser"></param>
        /// <returns></returns>
        public List<PollutionControlUserProfile> GetUserProfilesRFD(PollutionAuthStatus objUser)
        {
            SqlDataReader reader;
            List<PollutionControlUserProfile> list = new List<PollutionControlUserProfile>();
            object[] arr = new object[] {  "P_vch_Action","RFD",
                                           "P_vch_UserID",objUser.strUserID,
                                           "P_vch_ProposalID ",objUser.StrProposalID
                                        };
            try
        ...
        #endregion
        #region "Push User Data For Registration for dealers"
        /// <summary>
        /// Created By Anil Sahoo on 11-Oct-2022 for Push User Data For Registration for dealers
        /// </summary>
        /// <param name="objDATA"></param>
        /// <returns></returns>
        public List<PollutionPushDataStatus> SWPPushDataRFD(PollutionPushData objDATA)
        {
            ///// Write request log for each request.
            string strInput = "(Request)---Application No :- " + objDATA.strApplicationNumber;
            Util.LogRequestResponse("OSPCB", "SWPPushDataRFD", strInput);
            ...
            var json1 = jsonSerialiser1.Serialize(objDATA);
            string strPushdata = "(Pushdata)--- Data :- " + json1;
            Util.LogRequestResponse("OSPCB", "pushdataRFDservice", strPushdata);
            ...
            try
            {
                object[] objArray = new object[] { "P_vch_Action", "PRFD",
                                                   "P_vch_ProposalID",objDATA.strIndustryCode,
                                                   "P_VCH_INVESTOR_NAME",objDATA.strInvstorName,
                                                   "P_VCH_APPLICATION_UNQ_KEY",objDATA.strApplicationNumber,
                                                   "P_SERVICEID",objDATA.intServiceID,
                ...
                var json2 = jsonSerialiser2.Serialize(objResponse);
                string strOutput = "(Response)---OutputString:- " + json2;
                Util.LogRequestResponse("OSPCB", "getResponseRFD", strOutput);
                lstResponse.Add(objResponse);
            }
            catch (SqlException ex)
            {
