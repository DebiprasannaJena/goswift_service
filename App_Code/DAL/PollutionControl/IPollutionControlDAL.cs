...
namespace SWP_Services.DAL
{
    public interface IPollutionControlDAL
    {
        ...
        List<PollutionControlUserProfile> GetUserProfilesBMW(PollutionAuthStatus objUser);
        #endregion
        #region "Push User Data For Bio-Medical Waste"
        List<PollutionPushDataStatus> SWPPushDataBMW(PollutionPushData objDATA);
        #endregion

        #region  "Fetch User Profile Details For Municipal-Solid Waste"
        List<PollutionControlUserProfile> GetUserProfilesMSW(PollutionAuthStatus objUser);
        #endregion
        #region "Push User Data For Municipal-Solid Waste"
        List<PollutionPushDataStatus> SWPPushDataMSW(PollutionPushData objDATA);
        #endregion

        #region  "Fetch User Profile Details For Construction and Demolition Waste"
        List<PollutionControlUserProfile> GetUserProfilesCDW(PollutionAuthStatus objUser);
        #endregion
        #region "Push User Data For Construction and Demolition Waste"
        List<PollutionPushDataStatus> SWPPushDataCDW(PollutionPushData objDATA);
        #endregion

        #region  "Fetch User Profile Details For Registration for dealers"
        List<PollutionControlUserProfile> GetUserProfilesRFD(PollutionAuthStatus objUser);
        #endregion
        #region "Push User Data For Registration for dealers"
        List<PollutionPushDataStatus> SWPPushDataRFD(PollutionPushData objDATA);
        #endregion
    }
}